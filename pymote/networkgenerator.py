...
class NetworkGenerator(object):
    ...
    def generate_ring_network(self, center=None, x_radius=100, y_radius=100, sector=1.0):
        """
        Generates network where nodes are located approximately homogeneous.
        ...
        for _n in range(self.n_count):
                    ...
                    net.add_node(node, pos=(center[0] + cos(ang)*x_radius, center[1] + sin(ang)*y_radius), ori=ang)
