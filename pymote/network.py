...
class Network(Graph):
    ...
    def get_fig(self, title="Topology", x_label="X-axis", y_label="Y-axis",
        ...
        dpi = 90
        size =  self._environment.im.shape[0] + 100, self._environment.im.shape[1] + 100
        ...
        nx.draw_networkx_edges(net, pos, alpha=0.5, edgelist=edgelist, style='dashed', edge_color='r')
