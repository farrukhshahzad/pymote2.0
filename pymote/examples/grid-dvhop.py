...
position_stats.append(np.mean(position_stats, axis=0))
position_stats.append(np.min(position_stats, axis=0))
position_stats.append(np.max(position_stats, axis=0))
position_stats.append(np.std(position_stats, axis=0))
...
message_stats.append(np.mean(message_stats, axis=0))
message_stats.append(np.min(message_stats, axis=0))
message_stats.append(np.max(message_stats, axis=0))
message_stats.append(np.std(message_stats, axis=0))

stats += "Messages:<br>Avg: " + str(message_stats[-4][1:]) + \
...
plotter.gethtmlScatter(xpositions, [anchpositions, positions, newpos],
                ...
                comment=comments, show_range=str(int(node.commRange)),report=comments+"<br><br>" + str(stats),
