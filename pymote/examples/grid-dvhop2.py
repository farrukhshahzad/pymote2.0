...
maxHop = 8
method="DV-hop2"
n = 648  # total no of nodes
p_anchors = 7   # No. of anchors in %age
...
#net = net_gen.generate_grid_network(name="Random", randomness=0.8)
...
folder = DATETIME_DIR+ "-" + net_gen.name+"-N=" + str(nn)+"-hop=" + str(maxHop)
...
comments = "Runtime(s): "+ str(round(end_time,2)) + "(" + \
           ...
           ", MaxHop: " + str(maxHop) + ", |Err>R|: " + str(len(X2[X2>comm_range]))
