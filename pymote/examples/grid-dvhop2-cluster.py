...
net_gen = Topology(n_count=n, n_max=n, n_min=n, connected=False, doi=global_settings.DOI)
...
#net = net_gen.generate_cluster_network(name="Randomized",
#                 x_radius=x_radius, y_radius=y_radius,  sector=1,
...
comments = "Runtime(s): " + str(round(end_time, 1)) + "(" + \
           ...
           (", MaxHop: " + str(maxHop) if maxHop else ", " + method) + \
...
plotter.gethtmlScatter(xpositions, [anchpositions, positions, newpos],
                ...
                title=filename, open=1, axis_range={'xmin':0, 'ymin':0, 'xmax': w, 'ymax': h},
...
#                     title=filename, comment=comments, open=1,
